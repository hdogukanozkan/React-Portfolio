...
const Hero = () => {
  return (
    <div className="flex flex-col items-center lg:flex-row gap-2 max-w-6xl mx-auto">
      <div className="flex-1 flex flex-col gap-4 items-start">
        <h1 className="text-3xl w-full flex justify-center items-center lg:justify-start lg:items-start lg:text-5xl font-bold">
          Hi there, 👋🏻.
        </h1>
        <p className="text-lg">
          I am{" "}
          <span className="text-lime-400 dark:text-lime-700 font-bold">
            Doğukan Özkan
          </span>
          . Front-end Developer, I love coding & Always learning.
        </p>
        <p>🌱 I’m currently learning Node.js .</p>
        <div className="flex gap-3">
          <a
            href="https://github.com/hdogukanozkan"
            className="flex items-center justify-center rounded-full bg-black hover:shadow-3xl hover:shadow-gray-500  w-10 h-10  lg:w-12 lg:h-12 p-2"
          >
            <AiFillGithub className="text-white w-full h-full" />
          </a>
          <a
            href="https://www.linkedin.com/in/hanifi-do%C4%9Fukan-%C3%B6zkan-06046b214/"
            className="flex items-center justify-center rounded-full bg-blue-600 hover:shadow-3xl hover:shadow-blue-400  w-10 h-10  lg:w-12 lg:h-12 p-2"
          >
            <AiFillLinkedin className="text-white w-full h-full" />
          </a>
          <a
            href="mailto:hanifidogukanozkan@gmail.com"
            className="flex items-center justify-center rounded-full bg-red-700 hover:shadow-3xl hover:shadow-red-500 w-10 h-10  lg:w-12 lg:h-12 p-2"
          >
            <AiFillGoogleCircle className="text-white w-full h-full" />
          </a>
        </div>
      </div>
